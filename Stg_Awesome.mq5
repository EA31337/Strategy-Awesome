...
// Inputs.
INPUT_GROUP("Awesome strategy: main");
...
// Includes strategy.
#include "Stg_Awesome.mqh"

// Defines.
#define ea_name "Strategy Awesome"
#define ea_version "1.007"
#define ea_desc "Strategy based on EA31337 framework."
#define ea_link "https://github.com/EA31337/Strategy-Awesome"
...
int OnInit() {
  ...
  ea = new EA(ea_params);
  _result &= ea.StrategyAdd<Stg_Awesome>(Active_Tfs);
